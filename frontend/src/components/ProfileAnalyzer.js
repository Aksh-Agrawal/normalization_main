    ...
    <div className="card">
      ...
      <div style={{ 
        ...
        <ul style={{ 
          ...
          <li>⚖️ Calculates a unified rating using advanced normalization algorithms</li>
          <li>🎓 Adds bonus points for Coursera course completions</li>
          <li>📊 Provides detailed breakdowns and insights</li>
          <li>🔥 Generates activity heatmaps to visualize your coding journey</li>
        </ul>
      </div>
    </div>
  );
